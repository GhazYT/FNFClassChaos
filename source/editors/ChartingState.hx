...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_character = new FlxUICheckBox(150, 250, null, null, "Force Character", 100);
		...
		check_character.callback = function()
		{
			_song.forcecharcters = check_character.checked;
			//trace('CHECKED!');
		};
		...
		tab_group_song.add(check_character);
	...
	function loadSong():Void
	{
		...
		var file:Dynamic = Paths.voices(ClientPrefs.addon + currentSongName);
		vocals = new FlxSound();
	...
	function generateSong() {
		FlxG.sound.playMusic(Paths.inst(ClientPrefs.addon + currentSongName), 0.6/*, false*/);
	...
	function loadAudioBuffer() {
		...
		if(FileSystem.exists(Paths.modFolders('songs/' + currentSongName + '/Inst.ogg'))) {
			...
			var leVocals:String = Paths.getPath(ClientPrefs.addon + currentSongName + '/Inst.' + Paths.SOUND_EXT, SOUND, 'songs');
